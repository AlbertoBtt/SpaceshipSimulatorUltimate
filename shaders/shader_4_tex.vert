...
void main()
{
	...
	mat3 TBN2 = transpose(mat3(tangent,bitangent,normal));
        vec3 viewDir2 = normalize(viewDir);
	vec3 lightPos3 = normalize(lightDir);

        lightDirTS2 = TBN * lightPos3;
	lightDirTS2 = normalize(lightDirTS2);
	viewDirTS2 = TBN * viewDir2;
	viewDirTS2 = normalize(viewDirTS2);
